...
const STRINGS = {
  "zh-CN": {
    ...
    "tz.browser": "本机时区",
    "tz.label": "时区",
    "demo.banner": "在线模式 — 打开页面自动拉取 ESPN 最新数据",
    "demo.bannerFallback": "离线快照 — 实时接口不可用，显示上次导出数据",
    "demo.fallback": "快照",
    "filter.status": "状态",
    "filter.all": "全部",
    "filter.live": "进行中",
    ...
    "match.liveMinute": "第 {min} 分钟",
    "match.liveMinuteExtra": "第 {min}+{extra} 分钟",
    "match.halfTime": "中场休息",
    "hero.liveLabel": "比赛进行中",
  ...
  en: {
    ...
    "masthead.clickRefresh": "Click to refresh",
    ...
    "tz.label": "Timezone",
    "demo.banner": "Live mode — fetches latest ESPN data on each visit",
    "demo.bannerFallback": "Offline snapshot — live API unavailable",
    ...
    "match.spread": "Spread",
    "match.timeLocal": "{range} ({tz})",
    "match.liveMinute": "{min}'",
    "match.liveMinuteExtra": "{min}+{extra}'",
    "match.halfTime": "Half time",
    "hero.liveLabel": "Match in progress",
