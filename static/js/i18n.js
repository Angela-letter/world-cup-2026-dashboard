...
const STRINGS = {
  ...
  en: {
    ...
    "hero.venueBJ": "{time} Beijing · {venue}",
...
function fmtDateShort(iso) {
  return new Date(iso).toLocaleString(localeForDates(), {
